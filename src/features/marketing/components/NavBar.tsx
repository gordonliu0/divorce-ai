    ...
    <nav className="fixed top-0 z-50 flex h-16 w-full items-center justify-center bg-[hsl(0_0%_96.5%)]">
      <div className="flex w-full max-w-7xl items-center justify-between px-8">
        ...
        <div className="flex items-center gap-6">
          <Link
            className="text-[hsl(0_0%_45%)] text-sm transition-colors hover:text-[hsl(0_0%_12%)]"
            href={userData ? "/o" : "/auth/login"}
          >
            {userData ? "Platform" : "Sign In"}
          </Link>
          <Link
            className="group inline-flex items-center gap-1.5 rounded-full bg-[hsl(0_0%_12%)] px-4 py-2 font-medium text-[hsl(0_0%_96.5%)] text-sm transition-colors hover:bg-[hsl(0_0%_20%)]"
            href="/auth/signup"
          >
            Get Started
